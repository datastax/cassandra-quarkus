...
public class QuarkusDaoQueryProviderMethodGenerator extends DaoQueryProviderMethodGenerator {

  public QuarkusDaoQueryProviderMethodGenerator(
  ...
  protected Set<DaoReturnTypeKind> getSupportedReturnTypes() {
    ...
    for (QuarkusDaoReturnTypeKind value : QuarkusDaoReturnTypeKind.values()) {
      types.add(value);
    }
    return types.build();
  }
