...
Cassandra nodes. Versions up to 1.4.0 supported both Micrometer and MicroProfile metrics, however
with this version Quarkus plans to support only Micrometer going forward.  As a result we've
removed MicroProfile support in its entirety from this plugin.
